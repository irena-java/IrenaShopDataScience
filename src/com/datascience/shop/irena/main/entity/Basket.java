...
public class Basket {
    ...
    private User client;
    private com.datascience.shop.irena.main.entity.StatusBasket statusBasket;
    private List<OrderSegment> orderSegments = new ArrayList<>();
    private static long idCurrentBasket;

    public Basket(LocalDate dateCreateBasket, User client, com.datascience.shop.irena.main.entity.StatusBasket statusBasket, List<OrderSegment> orderSegments) {
    ...
    public com.datascience.shop.irena.main.entity.StatusBasket getStatusBasket() {
        return statusBasket;
    }

    public void setStatusBasket(com.datascience.shop.irena.main.entity.StatusBasket statusBasket) {
        this.statusBasket = statusBasket;
    }
